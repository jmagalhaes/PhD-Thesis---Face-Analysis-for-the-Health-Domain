...
\begin{figure}
    ...
    \label{fig:project}
\end{figure}
\todo{Figure:  legend to indicate what colors mean. keep frame color for main project parts as well as title font the same.Include all partners of the project}
...
has several insights which for many years have been ignored. In verbal communication face muscles are activated to produce speech, but also non-verbal communication needs 
