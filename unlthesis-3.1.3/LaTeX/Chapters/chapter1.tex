...
Although during conversations major attention is given to the spoken content, non-verbal communication processing occurs subconsciously. Besides the verbal content of speech, it contains also non-verbal elements known as paralanguage: voice quality, rate, pitch, volume, and speaking style, prosodic features such as rhythm, intonation, and stress. But there are additional visual cues part of the non-verbal communication which in total make two thirds of communication, namely, body language (kinesics), distance (proxemics), oculesics (eye contact, patterns of fixation, etc.), and touch (haptics)\cite{Burgoon2016}.
...
\begin{enumerate}
    ...
    \item \textbf{Facial paralysis}: detect and qualify the severity of facial paralysis.
\end{enumerate}
...
-search article: quantitiative assessment of bell's parsy using binary patterns. (google drive)\\
