...
\documentclass[
  doctype=phdplan,          % phd(*), phdplan, phdprop, msc, mscplan, bsc
  ...
  printcommittee=true,  % set to 'false' from submitted versins who should not have 
	...
	biblatex={            % Options for biblatex (see biblatex documentation)
		style=authoryear,      % numeric(*), alphabetic, authoryear, bwl-FU
...
\usepackage[disable]{todonotes}	% To register TODO notes in the text
...
\title{Multimodal Analysis of the Interaction between Motor Speech Disorders and Expressed Emotions Using Machine Learning Techniques}
\subtitle{Science is beautiful}

% Autor
% use [f] for female and [m] for male
\authorname[f]{Carla Luisa de Oliveira Viegas}{Carla Viegas}
...
% use [f] for female and [m] for male
\adviser[m]{João Magalhães}{Associate Professor}{\\& NOVA University of Lisbon} 
% you may use "\newline" to force a new line
\adviser[m]{Alexander Hauptmann}{Principal Systems Scientist}{\\&Carnegie Mellon University, Pittsburgh}
...
\aftercoverfile{aftercover-unl-ims}
...
\addlisttofrontmatter{\printnoidxglossaries}	% The Glossary and List of Acrnonyms
